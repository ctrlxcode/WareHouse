...
<div class="row">
    <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-th-list fa-fw"></i> ครุภัณฑ์การศึกษา : <?=$model->sap_code;?></h1>
    </div>
</div> 
<!-- <div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><a href="?r=computer">ครุภัณฑ์การศึกษา</a></li>
            <li class="active">แสดงข้อมูลครุภัณฑ์การศึกษา</li>
        </ol>
    </div>
</div>  --> 
<div class="row">
