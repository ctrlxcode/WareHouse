...
$this->title = 'ครุภัณฑ์โรงงาน';
// $this->params['breadcrumbs'][] = $this->title;
?>
<div class="row">
    <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-desktop fa-fw"></i> ครุภัณฑ์โรงงาน</h1>
    </div>
</div>       
  ...
  <!-- <div class="row">
      <div class="col-lg-12">
          <ol class="breadcrumb">
              ...
              <li class="active">ครุภัณฑ์โรงงาน</li>
          </ol>
      </div>
  </div> -->
   <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
      ...
      <?php
        if (Yii::$app->user->identity->isAdmin){ 
            ...
            echo Html::button('<i class="glyphicon glyphicon-plus"></i> เพิ่มครุภัณฑ์โรงงาน',['value'=>  Url::to('index.php?r=factory/create'),'class' => 'btn btn-success','id'=>'modalButton']); 
            echo "</p>";
      } ?>
   ...
   <?php
        ...
        $this->registerJS("$(function() {
            $('.popup-modal').click(function(e) {
                ...
                modal.find('.modal-title').text('ครุภัณฑ์โรงงาน :  \"' + name + '\"');
