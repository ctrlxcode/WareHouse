...
<div class="asset-master-update">
    ...
    <div class="row">
	    <div class="col-lg-12">
	            <h1 class="page-header"><i class="glyphicon glyphicon-pencil"></i> แก้ไขครุภัณฑ์โฆษณาและเผยแพร่ : <?=$model->sap_code;?></h1>
	    </div>
	</div>   
	<!-- <div class="row">
	    <div class="col-lg-12">
	        <ol class="breadcrumb">
	            ...
	            <li><a href="?r=computer">ครุภัณฑ์โฆษณาและเผยแพร่</a></li>
	            <li class="active">แก้ไขครุภัณฑ์โฆษณาและเผยแพร่</li>
	        </ol>
	    </div>
	</div> -->
