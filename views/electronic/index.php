...
<div class="row">
    <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-desktop fa-fw"></i> ครุภัณฑ์ไฟฟ้าและวิทยุ</h1>
    </div>
</div>       
   ...
   <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
      ...
      <?php
        if (Yii::$app->user->identity->isAdmin){ 
            ...
            echo Html::button('<i class="glyphicon glyphicon-plus"></i> เพิ่มครุภัณฑ์ไฟฟ้าและวิทยุ',['value'=>  Url::to('index.php?r=electronic/create'),'class' => 'btn btn-success','id'=>'modalButton']); 
            echo "</p>";
      } ?>
